...
var xlvcExchangeSchema = require('./json-schemas/xlvc-exchange.js')
...
Schema._validateExchange = function (json, _parentPath) {
  ...
  if (json.type === 'direct') {
  ...
  } else if (json.type === 'x-lvc') {
    jsonValidator(xlvcExchangeSchema, json, _parentPath)
  }else {
    ...
    var message = [
      "'", currPath, "' must be direct, topic, fanout or x-lvc"
    ].join('')
